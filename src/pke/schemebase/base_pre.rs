...
pub trait PREBase<Element> {
   ...
   */
    fn re_key_gen(old_private_key: PrivateKey<Element>,
                                       new_public_key: PublicKey<Element>) -> EvalKey<Element>;
   ...
   */
    fn  re_encrypt(ciphertext: ConstCiphertext<Element> , eval_key: EvalKey<Element>,
                                            public_key: PublicKey<Element>) ->  Ciphertext<Element>;
}